...
iris_feature_C = u'sepal_length', u'sepal_width', u'flower_long', u'flower_width'
...
plt.grid(True)
plt.title('iris data classification', fontsize=18)
#plt.show()
...
plt.grid(True)
plt.title('fitting problem', fontsize=18)
plt.show()