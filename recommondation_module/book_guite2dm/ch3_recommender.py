...
class recommender:
    ...
    def __init__(self, data, k=1, metric='pearson', n=5):
        ...
        self.k = k
        self.n = n
        self.username2id = {}  # dict
        self.userid2name = {}  # dict
        self.frequencies = {}
        self.deviations = {}
        self.productid2name = {}
        self.metric = metric
    ...
    '''
    Making predictions with Weighted Slope One 公式计算偏离率
    '''
