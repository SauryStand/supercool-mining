...
class kClusterer:
    ...
    def distanceToClosestCentroid(self, point, centroidList):
        ...
        result = self.Distance(point, centroidList[0])
...
###
#km = kClusterer('/Users/voyager2511/Documents/source_codes/others/supercool-mining/dataset/data/ch8/dogs.csv', 3)
km = kClusterer('/Users/voyager2511/Documents/source_codes/others/supercool-mining/dataset/data/ch8/enrondata.txt', 8)
km.kCluster()
km.showMembers()
